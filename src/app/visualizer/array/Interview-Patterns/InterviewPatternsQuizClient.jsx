...
export default function InterviewPatternsQuizClient() {
  const quizzes = [
    {
      title: "Sliding Window Quiz",
      description: "Practice the Sliding Window technique for optimizing array and string problems.",
    ...
    },
    {
      ...
      description: "Practice the Two Pointers technique for solving array and linked list problems.",
      href: "/visualizer/array/Interview-Patterns/quiz/twopointers",
      filename: "two_pointers_quiz.js",
      ...
      <section className="relative pt-6 pb-4">
        <div className="max-w-[1100px] mx-auto px-4">
          ...
          <h1 className="text-2xl md:text-3xl font-black mb-2">
            Interview Patterns Quiz Portal
          </h1>
          <p className="text-[14px] text-surface-600 dark:text-surface-400 font-medium">
            Test your understanding of common interview patterns. Select a specific challenge below.
          </p>
        </div>
      </section>
            ...
            >
              ...
              <div className="p-6 flex-1 flex flex-col justify-between">
                ...
                <Link href={quiz.href} className="block mt-auto w-full">
                  <button className="w-full h-11 rounded-xl bg-cyan-600 hover:bg-cyan-700 text-white font-bold text-[14px] flex items-center justify-center gap-2 shadow-sm hover:shadow-md transition-all">
